      ...
      <div className="container p-3 border-top">
        <div className="row mt-5">
          ...
          <div className="col-2 mb-3">
            <p>Account</p>
            <div className="footer-link text-muted mb-3">
        ...
        <div className="row mt-5 text-small text-muted fs-8" style={{ fontSize: "16px" }}>
          <p>
            ...
            please write to <a href="" style={{ textDecoration: "none" }}>complaints@zerodha.com</a>, for DP related to
          ...
          <p>
            India's largest broker based on networth as per NSE. <br />
